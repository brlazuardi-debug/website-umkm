    ...
    <div className="min-h-[75vh] flex items-center justify-center px-6 py-12 bg-stone-50 font-['Inter'] font-normal">
      <div className="w-full max-w-md flex flex-col items-center">
        <div className="text-center mb-8">
          <span className="text-amber-600 text-xs font-bold uppercase tracking-widest block mb-1">MEMBERSHIP</span>
          <h1 className="text-3xl font-bold uppercase tracking-tight text-black">{brand.name}</h1>
          <p className="text-stone-500 text-xs uppercase tracking-wider font-normal mt-1">Daftar untuk menikmati kurasi produk eksklusif.</p>
        </div>
